 ...
 */
public class Polynomials implements Polynomial {
  ...
  public Polynomial add(Polynomial other) throws IllegalArgumentException {
    Polynomial addition = new Polynomials();
    ...
    for (int i = 0; i < ((Polynomials) other).getList().getSizeOfList(); i++) {
      Poly polyNow = ((Polynomials) other).getList().getPolyatIndex(i);
